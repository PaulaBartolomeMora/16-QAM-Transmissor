...
#
# Generated by Vivado on Sat Nov 11 10:43:32 +0100 2023
...
# Design libraries
design_libs=(xil_defaultlib xpm xlslice_v1_0_1 fifo_generator_v13_2_1)
...
compile()
{
  ...
  vlogan -work xlslice_v1_0_1 $vlogan_opts +v2k \
    "$ref_dir/../../../../P1_fifo_xadc.srcs/sources_1/bd/design_1/ipshared/f3db/hdl/xlslice_v1_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work fifo_generator_v13_2_1 $vlogan_opts +v2k \
    "$ref_dir/../../../../P1_fifo_xadc.srcs/sources_1/bd/design_1/ipshared/5c35/simulation/fifo_generator_vlog_beh.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work fifo_generator_v13_2_1 $vhdlan_opts \
    "$ref_dir/../../../../P1_fifo_xadc.srcs/sources_1/bd/design_1/ipshared/5c35/hdl/fifo_generator_v13_2_rfs.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work fifo_generator_v13_2_1 $vlogan_opts +v2k \
    "$ref_dir/../../../../P1_fifo_xadc.srcs/sources_1/bd/design_1/ipshared/5c35/hdl/fifo_generator_v13_2_rfs.v" \
  2>&1 | tee -a vlogan.log
