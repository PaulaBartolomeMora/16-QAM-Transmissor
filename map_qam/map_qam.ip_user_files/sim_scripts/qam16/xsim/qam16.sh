...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xbip_utils_v3_0_8 -L axi_utils_v2_0_4 -L fir_compiler_v7_2_10 -L secureip -L xpm --snapshot qam16 xil_defaultlib.qam16 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim qam16 -key {Behavioral:sim_1:Functional:qam16} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb qam16.wdb xsim.dir)
